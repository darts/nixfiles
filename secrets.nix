let 
  ...
  hostHoas = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIH5hFmwIx7+lzUbNXeSpxIfpljHZkCbJlux3IJsC32aT";
in
{
  "secrets/host-nixos-password.age".publicKeys = [ dev hostNixos hostHoas ];
}
